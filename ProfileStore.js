...
function offlineDevice(profile, key, kind, migrationState, migrationReason) {
  ...
  return {
    ...
    identityQuality: String(profile.identityQuality || ""),
    identificationEvidence: String(profile.identificationEvidence || ""),
    identificationScope: String(profile.identificationScope || ""),
